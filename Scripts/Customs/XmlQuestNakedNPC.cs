...
{
	public class XmlQuestNakedNPC : TalkingBaseCreature
	{

        [Constructable]
        public XmlQuestNakedNPC() : this(-1)
        {
        }

        [Constructable]
        public XmlQuestNakedNPC(int gender) : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 )
        {
            SetStr( 10, 30 );
            SetDex( 10, 30 );
            SetInt( 10, 30 );
        ...
        public XmlQuestNakedNPC( Serial serial ) : base( serial )
        {
        }
