...
namespace Server.Mobiles
{
	...
	public class NOrcishLord : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public NOrcishLord() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an orcish Lord";
			Body = 0x190;
                        Hue = 667;
			...
			AddItem( new OrcLegs());
			AddItem( new Cloak(Hue=32));
			AddItem( new BodySash(Hue=32));
			AddItem( new OrcChest());
                        AddItem( new OrcGloves());
                        AddItem( new OrcTetsubo());
		...
		public NOrcishLord( Serial serial ) : base( serial )
		{
		}
