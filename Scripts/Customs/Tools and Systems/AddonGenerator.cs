...
namespace Arya.Misc
{
    public class AddonGenerator
    {
        ...
        /// </summary>
        private static string m_CustomOutputDirectory = @"C:\Users\Tim\Desktop\UO Files\JustUO Release 1";
...
{complexnamecomponentscode}
	...
	public class {name}AddonDeed : BaseAddonDeed
	{
        ...
        private static void OnAddonGen(CommandEventArgs e)
        {
            ...
            state[12] = state[14] = state[16] = 39479;// 36653;
                ...
                foreach (object o in en)
                {
                    ...
                    if (getItems)
                    {
                        ...
                        if (i == null)
                            ...
                            continue;
                        else if (i.ItemID < 2 || i.ItemID > 39479) // This is not an Item within the normal artwork.. multi... etc.. Toss it
                            continue;
