...
namespace Server.Items
{
	...
	{
		[Constructable]
		public VesperInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpVesperFelucca()
		{
			CleanUpSpawns( "VesperInvasionFelucca" );
			CleanUpWayPoints( "VesperInvasionFelucca" );

		}
		public virtual void StopVesperFelucca()
		{
...

			{
				...
				{
					((VesperInvasionStone)item).CleanUpVesperFelucca();
				}
			}
		}
        public virtual void CleanUpVesperTrammel()
        {
            CleanUpSpawns("VesperInvasionTrammel");
            CleanUpWayPoints("VesperInvasionTrammel");

        }
        public virtual void StopVesperTrammel()
        {
            ...
            foreach (Item item in vespertram)
            {
                if (item is VesperInvasionStone)
                {
                    ((VesperInvasionStone)item).CleanUpVesperTrammel();
                }
            }
        }
		public VesperInvasionStone( Serial serial ) : base( serial )
		{
		}
