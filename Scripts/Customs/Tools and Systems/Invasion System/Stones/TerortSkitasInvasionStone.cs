...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  TerortSkitasInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpTerortSkitasIlshenar()
		{
			CleanUpSpawns( "TerortSkitasInvasionIlshenar" );
			CleanUpWayPoints( "TerortSkitasInvasionIlshenar" );

		}
		public virtual void StopTerortSkitasIlshenar()
		{
...

			{
				...
				{
					((TerortSkitasInvasionStone)item).CleanUpTerortSkitasIlshenar();
				}
			}
		}
		public  TerortSkitasInvasionStone( Serial serial ) : base( serial )
		{
		}
