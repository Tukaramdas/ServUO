...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  AncientCitadelInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpAncientCitadelIlshenar()
		{
			CleanUpSpawns( "AncientCitadelInvasionIlshenar" );
			CleanUpWayPoints( "AncientCitadelInvasionIlshenar" );

		}
		public virtual void StopAncientCitadelIlshenar()
		{
...

			{
				...
				{
					((AncientCitadelInvasionStone)item).CleanUpAncientCitadelIlshenar();
				}
			}
		}
		public  AncientCitadelInvasionStone( Serial serial ) : base( serial )
		{
		}
