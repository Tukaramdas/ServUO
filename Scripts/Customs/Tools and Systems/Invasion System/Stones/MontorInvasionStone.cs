...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  MontorInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpMontorIlshenar()
		{
			CleanUpSpawns( "MontorInvasionIlshenar" );
			CleanUpWayPoints( "MontorInvasionIlshenar" );

		}
		public virtual void StopMontorIlshenar()
		{
...

			{
				...
				{
					((MontorInvasionStone)item).CleanUpMontorIlshenar();
				}
			}
		}
		public  MontorInvasionStone( Serial serial ) : base( serial )
		{
		}
