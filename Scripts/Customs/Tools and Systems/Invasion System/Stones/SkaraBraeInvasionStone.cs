...
namespace Server.Items
{
	...
	{
		[Constructable]
		public SkaraBraeInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpSkaraBraeFelucca()
		{
			CleanUpSpawns( "SkaraBraeInvasionFelucca" );
			CleanUpWayPoints( "SkaraBraeInvasionFelucca" );

		}
		public virtual void StopSkaraBraeFelucca()
		{
...

			{
				...
				{
					((SkaraBraeInvasionStone)item).CleanUpSkaraBraeFelucca();
				}
			}
		}
        public virtual void CleanUpSkaraBraeTrammel()
        {
            CleanUpSpawns("SkaraBraeInvasionTrammel");
            CleanUpWayPoints("SkaraBraeInvasionTrammel");

        }
        public virtual void StopSkaraBraeTrammel()
        {
            ...
            foreach (Item item in skaratram)
            {
                if (item is SkaraBraeInvasionStone)
                {
                    ((SkaraBraeInvasionStone)item).CleanUpSkaraBraeTrammel();
                }
            }
        }
		public SkaraBraeInvasionStone( Serial serial ) : base( serial )
		{
		}
