...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  LakeShireMiregInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpLakeShireMiregIlshenar()
		{
			CleanUpSpawns( "LakeShireMiregInvasionIlshenar" );
			CleanUpWayPoints( "LakeShireMiregInvasionIlshenar" );

		}
		public virtual void StopLakeShireMiregIlshenar()
		{
...

			{
				...
				{
					((LakeShireMiregInvasionStone)item).CleanUpLakeShireMiregIlshenar();
				}
			}
		}
		public  LakeShireMiregInvasionStone( Serial serial ) : base( serial )
		{
		}
