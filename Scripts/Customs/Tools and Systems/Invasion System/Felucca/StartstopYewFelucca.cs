...
namespace Server.Gumps
{
	public class StartStopYewfel : Gump
	{
		...
		public StartStopYewfel(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "YewInvasionFelucca";
			point1.Name = "YewInvasionFelucca";
			point2.Name = "YewInvasionFelucca";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "YewInvasionFelucca";
			spawner1.Respawn();
			...
			spawner2.Name = "YewInvasionFelucca";
			spawner2.Respawn();
			...
			spawner3.Name = "YewInvasionFelucca";
			spawner3.Respawn();
			...
			spawner4.Name = "YewInvasionFelucca";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Yew Felucca is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			yewfel.StopYewFelucca();
                                          World.Broadcast( 33, true, "Yew Felucca's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
