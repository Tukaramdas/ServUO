...
namespace Server.Gumps
{
	public class StartStopVesperfel : Gump
	{
		...
		public StartStopVesperfel(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "VesperInvasionFelucca";
			point1.Name = "VesperInvasionFelucca";
			point2.Name = "VesperInvasionFelucca";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "VesperInvasionFelucca";
			spawner1.Respawn();
			...
			spawner2.Name = "VesperInvasionFelucca";
			spawner2.Respawn();
			...
			spawner3.Name = "VesperInvasionFelucca";
			spawner3.Respawn();
			...
			spawner4.Name = "VesperInvasionFelucca";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Vesper Felucca is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			Vesperfel.StopVesperFelucca();
                                          World.Broadcast( 33, true, "Vesper Felucca's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
