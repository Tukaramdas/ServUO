...
{
	public class StartStopLunaMalas : Gump
	{
		private Mobile m_Mobile;
		public StartStopLunaMalas(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 0:
		{ 
                                    from.CloseGump( typeof( StartStopLunaMalas ) ); 
		...
		case 1:
		{
			...
			point.Name = "LunaInvasionMalas";
			point1.Name = "LunaInvasionMalas";
			point2.Name = "LunaInvasionMalas";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "LunaInvasionMalas";
			spawner1.Respawn();
			...
			spawner2.Name = "LunaInvasionMalas";
			spawner2.Respawn();
			...
			spawner3.Name = "LunaInvasionMalas";
			spawner3.Respawn();
			...
			spawner4.Name = "LunaInvasionMalas";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Luna Malas is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			lunmal.StopLunaMalas();
                                          World.Broadcast( 33, true, "Luna Malas's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
