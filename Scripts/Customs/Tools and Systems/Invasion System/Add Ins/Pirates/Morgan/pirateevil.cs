...
{ 
   ...
   { 
      [Constructable] 
      public EvilPirate() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.17, 0.2 ) 
      { 
         ...
         SetSkill( SkillName.Wrestling, 55.0, 90.5 ); 
         ...
         { 
            case 0: AddItem( new BeverageBottle ( BeverageType.Ale ) ); break; 
            case 1: AddItem( new Lime() ); break; 
            case 2: AddItem( new GoldRing() ); break; 
            case 3: AddItem( new SeaChart() ); break; 
            case 4: AddItem( new BeverageBottle ( BeverageType.Wine ) ); break; 
            case 5: AddItem( new BeverageBottle ( BeverageType.Liquor ) ); break; 
            case 6: AddItem( new Sextant() ); break; 
            case 7: AddItem( new Lemon() ); break; 
...
//PackItem( new Token( 50, 125 ) );
      ...
      public EvilPirate( Serial serial ) : base( serial ) 
      { 
      } 
