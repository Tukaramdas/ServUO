...
namespace Server.Items
{
	...
	{
		[Constructable]
		public AssemblyRepairKit( ) : base( 0x1eba )
		{
			Name = "assembly repair kit";
			Weight = 1.0;
		}

		public AssemblyRepairKit( Serial serial ) : base( serial )
		{
		}
		...
		private class InternalTimer : Timer
		{
			...
			public InternalTimer( AssemblyRepairKit kit, Mobile tinker, Mobile assembly, TimeSpan duration ) : base( duration )
			{
				m_Kit = kit;
				m_Tinker = tinker;
				m_Assembly = assembly;
			...
			protected override void OnTick()
			{
				...
				if ( m_Kit.Deleted || !m_Tinker.CanSee( m_Kit ) || !m_Tinker.CanSee( m_Assembly ) || ironingot == null ) return;
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget( AssemblyRepairKit kit ) : base( 1, false, TargetFlags.Beneficial )
			{
				m_Kit = kit;
			}
