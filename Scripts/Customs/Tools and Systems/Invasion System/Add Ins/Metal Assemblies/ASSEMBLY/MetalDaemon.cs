...
namespace Server.Mobiles
{
	...
	public class MetalDaemon : BaseAssembly
	{
		...
		public MetalDaemon(): base()
		{
                        ...
                        switch ( Utility.Random( 8 ) )
			{
				...
				case 3: PackItem( new IronIngot(25) ); break;
                                case 4: PackItem( new DaemonPowerCore() ); break;

			}
                        switch ( Utility.Random( 6 ) )
			{
				case 0: PackItem( new DaemonPowerCore() ); break;
				...
				case 4: PackItem( new IronIngot(25) ); break;
                                case 5: PackItem( new DaemonBone(25) ); break;
			}
                        switch ( Utility.Random( 7 ) )
			{
				...
				case 3: PackItem( new IronIngot(50) ); break;
                                case 4: PackItem( new DaemonBone(25) ); break;
			}
		...
		public MetalDaemon( Serial serial ) : base( serial )
		{
		}
