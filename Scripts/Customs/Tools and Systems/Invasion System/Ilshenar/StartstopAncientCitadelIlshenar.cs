...
namespace Server.Gumps
{
	public class StartStopAncientCitadelilsh : Gump
	{
		...
		public StartStopAncientCitadelilsh(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "AncientCitadelInvasionIlshenar";
			point1.Name = "AncientCitadelInvasionIlshenar";
			point2.Name = "AncientCitadelInvasionIlshenar";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "AncientCitadelInvasionIlshenar";
			spawner1.Respawn();
			...
			spawner2.Name = "AncientCitadelInvasionIlshenar";
			spawner2.Respawn();
			...
			spawner4.Name = "AncientCitadelInvasionIlshenar";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Ancient Citadel Ilshenar is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			ancilsh.StopAncientCitadelIlshenar();
                                          World.Broadcast( 33, true, "Ancient Citadel Ilshenar's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
