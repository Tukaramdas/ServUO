...
namespace Server.Gumps
{
	public class StartStopSavageCampilsh : Gump
	{
		...
		public StartStopSavageCampilsh(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "SavageCampInvasionIlshenar";
			point1.Name = "SavageCampInvasionIlshenar";
			point2.Name = "SavageCampInvasionIlshenar";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "SavageCampInvasionIlshenar";
			spawner1.Respawn();
			...
			spawner2.Name = "SavageCampInvasionIlshenar";
			spawner2.Respawn();
			...
			spawner3.Name = "SavageCampInvasionIlshenar";
			spawner3.Respawn();
			...
			spawner4.Name = "SavageCampInvasionIlshenar";
			spawner4.Respawn();

                      World.Broadcast( 33, true, "Savage Camp Ilshenar is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			savilsh.StopSavageCampIlshenar();
      World.Broadcast( 33, true, "Savage Camp Ilshenar's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
