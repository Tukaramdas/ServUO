...
//  
//	
//  Quests Locations Ver. 1.0 
//  
//  Based on Runebook T-Hunting Files Original Ideas and code by // A_Li_N // Senior Member
//  
//  Love the script!  Tukaram added Zeefzorpul locations, and cleaned up Z Axis on T-Map runes 6JAN15
//   Added Quests and my XMLSPawners 19JAN16
...
{
		public class RuneLibraryQuests : Item
	{
		private static string pathlist = "Data/RuneLibraryQuests.txt";
      ...
      {
         CommandSystem.Register( "RuneLibraryQuests", AccessLevel.Administrator, new CommandEventHandler( RuneLibraryQuests_OnCommand ) );
      }

		public static void RuneLibraryQuests_OnCommand( CommandEventArgs args )
		{
			Mobile m = args.Mobile;
         RuneLibraryQuests rl = new RuneLibraryQuests(m);
		}
		...
		[Constructable]
		public RuneLibraryQuests (Mobile from)
		{
			...
			for( int i=0; i<size; i++ )
			{
				...
				{
					rb.Name = "Quests " + nameStart + " - " + (nameEnd-1);
					library.Add(rb);
					rb = new Runebook(0);
					nameStart = nameEnd;
				}
		...
		public RuneLibraryQuests( Serial serial ) : base( serial )
		{
		}
