...
//
//  * Z-axis fix on RuneLibraryTMaps.txt file by Tukaram 6JAN14                           *
...
{
	public class RuneLibraryTramSpawners : Item
	{
		private static string pathlist = "Data/RuneLibraryTramSpawners.txt";
      ...
      {
         CommandSystem.Register( "RuneLibraryTramSpawners", AccessLevel.Administrator, new CommandEventHandler( RuneLibraryTramSpawners_OnCommand ) );
      }

		public static void RuneLibraryTramSpawners_OnCommand( CommandEventArgs args )
		{
			Mobile m = args.Mobile;
         	RuneLibraryTramSpawners rl = new RuneLibraryTramSpawners(m);
		}
		...
		[Constructable]
		public RuneLibraryTramSpawners (Mobile from)
		{
			...
			for( int i=0; i<size; i++ )
			{
				...
				{
					rb.Name = "Trammel Spawners " + nameStart + " - " + (nameEnd-1);
					library.Add(rb);
					rb = new Runebook(0);
					nameStart = nameEnd;
				}
		...
		public RuneLibraryTramSpawners( Serial serial ) : base( serial )
		{
		}
