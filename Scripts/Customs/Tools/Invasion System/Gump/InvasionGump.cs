...
namespace Server.Gumps
{
	public class CityInvasion : Gump
	{
		...
		{ 
			CommandSystem.Register( "invasion", AccessLevel.Administrator, new CommandEventHandler( CityInvasion_OnCommand ) );
		} 
		private static void CityInvasion_OnCommand( CommandEventArgs e )
		{ 
			e.Mobile.SendGump( new CityInvasion( e.Mobile ) );
		} 
		public CityInvasion( Mobile from ) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
		        ...
		        from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Britain.");
                                    break; 
                            }  
		case 2:
		{
		        ...
		        from.PlaySound( 0x1FA );
		        Effects.SendLocationEffect( from, from.Map, 14201, 16 );
		        from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Minoc.");
                                    break; 
                            }  
		case 3:
		{
		        ...
		        from.PlaySound( 0x1FA );
		        Effects.SendLocationEffect( from, from.Map, 14201, 16 );
		        from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Cove.");
		...
		case 4:
		{
		        ...
		        from.PlaySound( 0x1FA );
		        Effects.SendLocationEffect( from, from.Map, 14201, 16 );
		        from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Buccaneers Den.");
		...
		case 5:
		{
		        ...
		        from.PlaySound( 0x1FA );
		        Effects.SendLocationEffect( from, from.Map, 14201, 16 );
		        from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Trinsic.");
		...
		case 6:
		{
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Vesper.");
		...
		case 11:
		{
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Skara Brae.");
		...
		case 12:
		{
		        ...
		        from.PlaySound( 0x1FA );
		        Effects.SendLocationEffect( from, from.Map, 14201, 16 );
		        from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Magincia.");
		...
		case 13:
		{
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Yew.");
		...
		case 23:
		{
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Nu'jelm.");
		...
		case 25:
		{
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Mistas.");
		...
		case 26:
		{
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Montor.");
        ...
        case 27:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Reg Volon.");
        ...
        case 28:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Savage Camp.");
        ...
        case 29:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Gargoyle City.");
        ...
        case 30:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Lakeshire.");
        ...
        case 31:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Ancient Citadel.");
        ...
        case 32:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Terort Skitas.");
        ...
        case 33:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Luna.");
            from.SendGump(new StartStopLunaMalas(from));
            break;
        }
        case 34:
        {
            ...
            from.PlaySound(0x1FA);
            Effects.SendLocationEffect(from, from.Map, 14201, 16);
            from.SendAsciiMessage("The world around you twists and fades. Suddenly, you are in Umbra.");
            from.SendGump(new StartStopUmbraMalas(from));
            break;
        }
			}
		}
