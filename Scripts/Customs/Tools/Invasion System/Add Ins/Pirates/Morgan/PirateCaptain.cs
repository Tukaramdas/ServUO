//Pirate Captain....Made by Grae using RunUO RCO 1.0;
using System;
...
{
	[CorpseName( "a Pirate Captain corpse" )]
	public class piratecaptain2 : BaseCreature
	{
		[Constructable]
		public piratecaptain2() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) // AI_ melee or mage.
		{
