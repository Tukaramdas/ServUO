...
namespace Server.Mobiles
    ...
    public abstract class BaseSpecialCreature : BaseCreature
        ...
        public virtual double EarthquakingChance { get { return 0.50; } }
...
// Bleed Attack 2% chance
  ...
  base.OnGaveMeleeAttack( defender );
		...
		private class InternalBleedTimer : Timer
		{
			...
			public InternalBleedTimer( Mobile from, Mobile m ) : base( TimeSpan.FromSeconds( 2.0 ), TimeSpan.FromSeconds( 2.0 ) )
			{
				m_From = from;
				m_Mobile = m;
