...
namespace Server.Mobiles
{
	...
	public class IronDragon : BaseAssembly
	{
		...
		public IronDragon() : base()
		{
			...
			SetSkill( SkillName.Macing, 95, 95 );
...
MF_Displacer = true;
                        ...
                        switch ( Utility.Random( 8 ) )
			{
				...
				case 1: PackItem( new DragonsBlood(50) ); break;
				case 2: PackItem( new RunicClockworkAssembly() ); break;
			...
			{
				case 0: PackItem( new DragonPowerCore() ); break;
				case 1: PackItem( new DragonsBlood(50) ); break;
				case 2: PackItem( new Gears(10) ); break;
				case 3: PackItem( new AssemblyUpgradeKit() ); break;
				case 4: PackItem( new IronIngot(25) ); break;
				case 5: PackItem( new ValoriteIngot(50) ); break;
			}
                        switch ( Utility.Random( 8 ) )
			{
				...
				case 1: PackItem( new DragonsBlood(50) ); break;
				case 2: PackItem( new RunicClockworkAssembly() ); break;
				case 3: PackItem( new Gears(10) ); break;
				case 4: PackItem( new IronIngot(50) ); break;
			}
		}
