...
namespace Server.Mobiles
{
	...
	//todo 	private bool		m_AlwaysObey = true;		// Creature always obeys commands. Horses and pack horses for example
		...
		[Constructable]
		public BaseAssembly() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.7, 1.0 )
		{
                        ControlSlots = 3;
		}
		...
		public bool UpgradeAssembly()
		{
			...
			Skills[SkillName.Macing].Cap += 5;
			Skills[SkillName.Swords].Cap += 5;
			Skills[SkillName.Fencing].Cap += 5;
			Skills[SkillName.Wrestling].Cap += 5;
			Skills[SkillName.Archery].Cap += 5;
		...
		public BaseAssembly( Serial serial ) : base( serial )
		{
		}
