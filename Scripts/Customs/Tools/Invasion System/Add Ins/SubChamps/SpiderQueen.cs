...
namespace Server.Mobiles
{
	public class SpiderQueen : BaseChampion
	{
        ...
        public override Type[] SharedList { get { return new Type[] { typeof(ANecromancerShroud), typeof(CaptainJohnsHat) }; } }
		...
		[Constructable]
		public SpiderQueen() : base( AIType.AI_Mage )
		{
			Body = 0x48;
			Hue = 2412;
			Name = "SpiderQueen";
			...
			SetSkill( SkillName.EvalInt, 127.1, 160 );
			...
			SetSkill( SkillName.Wrestling, 127.6, 140 );
