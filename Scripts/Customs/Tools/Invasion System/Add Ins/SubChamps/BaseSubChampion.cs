...
namespace Server.Mobiles
{
	...
	{
		public BaseSubChampion( AIType aiType ) : this( aiType, FightMode.Closest )
		{
                      ControlSlots = 150;
		}

		public BaseSubChampion( AIType aiType, FightMode mode ) : base( aiType, mode, 18, 1, 0.1, 0.2 )
		{
		}

		public BaseSubChampion( Serial serial ) : base( serial )
		{
		}
