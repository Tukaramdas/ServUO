...
namespace Server.Gumps
{
	public class StartStopTrinsicfel : Gump
	{
		...
		public StartStopTrinsicfel(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "TrinsicInvasionFelucca";
			point1.Name = "TrinsicInvasionFelucca";
			point2.Name = "TrinsicInvasionFelucca";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "TrinsicInvasionFelucca";
			spawner1.Respawn();
			...
			spawner2.Name = "TrinsicInvasionFelucca";
			spawner2.Respawn();
			...
			spawner3.Name = "TrinsicInvasionFelucca";
			spawner3.Respawn();
			...
			spawner4.Name = "TrinsicInvasionFelucca";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Trinsic Felucca is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			Trinsicfel.StopTrinsicFelucca();
                                          World.Broadcast( 33, true, "Trinsic Felucca's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
