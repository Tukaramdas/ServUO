...
namespace Server.Gumps
{
	public class StartStopRegVolonilsh : Gump
	{
		...
		public StartStopRegVolonilsh(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "RegVolonInvasionIlshenar";
			point1.Name = "RegVolonInvasionIlshenar";
			point2.Name = "RegVolonInvasionIlshenar";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "RegVolonInvasionIlshenar";
			spawner1.Respawn();
			...
			spawner2.Name = "RegVolonInvasionIlshenar";
			spawner2.Respawn();
			...
			spawner3.Name = "RegVolonInvasionIlshenar";
			spawner3.Respawn();
			...
			spawner4.Name = "RegVolonInvasionIlshenar";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Reg Volon Ilshenar is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			regilsh.StopRegVolonIlshenar();
                                          World.Broadcast( 33, true, "Reg Volon Ilshenar's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
