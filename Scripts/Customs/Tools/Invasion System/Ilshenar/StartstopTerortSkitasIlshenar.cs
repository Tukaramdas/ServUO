...
namespace Server.Gumps
{
	public class StartStopTerortSkitasilsh : Gump
	{
		...
		public StartStopTerortSkitasilsh(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "TerortSkitasInvasionIlshenar";
			point1.Name = "TerortSkitasInvasionIlshenar";
			point2.Name = "TerortSkitasInvasionIlshenar";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "TerortSkitasInvasionIlshenar";
			spawner1.Respawn();
			...
			spawner2.Name = "TerortSkitasInvasionIlshenar";
			spawner2.Respawn();
			...
			spawner3.Name = "TerortSkitasInvasionIlshenar";
			spawner3.Respawn();
			...
			spawner4.Name = "TerortSkitasInvasionIlshenar";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Terort Skitas Ilshenar is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			terilsh.StopTerortSkitasIlshenar();
                                          World.Broadcast( 33, true, "Terort Skitas Ilshenar's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
