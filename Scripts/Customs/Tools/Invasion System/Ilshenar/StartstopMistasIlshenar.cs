...
namespace Server.Gumps
{
	public class StartStopMistasilsh : Gump
	{
		...
		public StartStopMistasilsh(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "MistasInvasionIlshenar";
			point1.Name = "MistasInvasionIlshenar";
			point2.Name = "MistasInvasionIlshenar";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "MistasInvasionIlshenar";
			spawner1.Respawn();
			...
			spawner2.Name = "MistasInvasionIlshenar";
			spawner2.Respawn();
			...
			spawner3.Name = "MistasInvasionIlshenar";
			spawner3.Respawn();
			...
			spawner4.Name = "MistasInvasionIlshenar";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Mistas Ilshenar is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			misilsh.StopMistasIlshenar();
                                          World.Broadcast( 33, true, "Mistas Ilshenar's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
