...
namespace Server.Gumps
{
	public class StartStopGargoyleCityilsh : Gump
	{
		...
		case 1:
		{
            ...
            point.Name = "GargoyleCityInvasionIlshenar";
            point1.Name = "GargoyleCityInvasionIlshenar";
            point2.Name = "GargoyleCityInvasionIlshenar";
            ...
            spawner1.Name = "GargoyleCityInvasionIlshenar";
			spawner1.Respawn();
            ...
            spawner2.Name = "GargoyleCityInvasionIlshenar";
			spawner2.Respawn();
            ...
            spawner3.Name = "GargoyleCityInvasionIlshenar";
			spawner3.Respawn();
            ...
            spawner4.Name = "GargoyleCityInvasionIlshenar";
			spawner4.Respawn();

            World.Broadcast(33, true, "Gargoyle City Ilshenar is under invasion.");
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
            ...
            garcitilsh.StopGargoyleCityIlshenar();
            World.Broadcast(33, true, "Gargoyle City Ilshenar's invasion was successfully beaten back. No more invaders are left in the city.");
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
