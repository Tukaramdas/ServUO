...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  GargoyleCityInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
        ...
        public virtual void CleanUpGargoyleCityIlshenar()
		{
			CleanUpSpawns( "GargoyleCityInvasionIlshenar" );
			CleanUpWayPoints( "GargoyleCityInvasionIlshenar" );

		}
        public virtual void StopGargoyleCityIlshenar()
		{
...

			{
				...
				{
                    ((GargoyleCityInvasionStone)item).CleanUpGargoyleCityIlshenar();
				}
			}
		}
