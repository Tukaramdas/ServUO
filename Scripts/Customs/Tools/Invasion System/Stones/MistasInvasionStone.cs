...
namespace Server.Items
{
	...
	{
		[Constructable]
		public MistasInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpMistasIlshenar()
		{
			CleanUpSpawns( "MistasInvasionIlshenar" );
			CleanUpWayPoints( "MistasInvasionIlshenar" );

		}
		public virtual void StopMistasIlshenar()
		{
...

			{
				...
				{
					((MistasInvasionStone)item).CleanUpMistasIlshenar();
				}
			}
		}
		public MistasInvasionStone( Serial serial ) : base( serial )
		{
		}
