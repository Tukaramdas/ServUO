...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  SavageCampInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpSavageCampIlshenar()
		{
			CleanUpSpawns( "SavageCampInvasionIlshenar" );
			CleanUpWayPoints( "SavageCampInvasionIlshenar" );

		}
		public virtual void StopSavageCampIlshenar()
		{
...

			{
				...
				{
					((SavageCampInvasionStone)item).CleanUpSavageCampIlshenar();
				}
			}
		}
		public  SavageCampInvasionStone( Serial serial ) : base( serial )
		{
		}
