...
namespace Server.Items
{
	...
	{
		[Constructable]
		public UmbraInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpUmbraMalas()
		{
			CleanUpSpawns( "UmbraInvasionMalas" );
			CleanUpWayPoints( "UmbraInvasionMalas" );

		}
		public virtual void StopUmbraMalas()
		{
...

			{
				...
				{
					((UmbraInvasionStone)item).CleanUpUmbraMalas();
				}
			}
		}
		public UmbraInvasionStone( Serial serial ) : base( serial )
		{
		}
