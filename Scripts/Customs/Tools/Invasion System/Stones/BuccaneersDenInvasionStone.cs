...
namespace Server.Items
{
	...
	{
		[Constructable]
		public BuccaneersDenInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpBuccaneersDenFelucca()
		{
			CleanUpSpawns( "BuccaneersDenInvasionFelucca" );
			CleanUpWayPoints( "BuccaneersDenInvasionFelucca" );

		}
		public virtual void StopBuccaneersDenFelucca()
		{
...

			{
				...
				{
					((BuccaneersDenInvasionStone)item).CleanUpBuccaneersDenFelucca();
				}
			}
		}
		public virtual void CleanUpBuccaneersDenTrammel()
		{
			CleanUpSpawns( "BuccaneersDenInvasionTrammel" );
			CleanUpWayPoints( "BuccaneersDenInvasionTrammel" );

		}
		public virtual void StopBuccaneersDenTrammel()
		{
...

			{
				if( item is BuccaneersDenInvasionStone )
				{
					((BuccaneersDenInvasionStone)item).CleanUpBuccaneersDenTrammel();
				}
			}
		}
		public BuccaneersDenInvasionStone( Serial serial ) : base( serial )
		{
		}
