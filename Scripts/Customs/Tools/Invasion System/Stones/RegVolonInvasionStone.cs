...
namespace Server.Items
{
	...
	{
		[Constructable]
		public  RegVolonInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpRegVolonIlshenar()
		{
			CleanUpSpawns( "RegVolonInvasionIlshenar" );
			CleanUpWayPoints( "RegVolonInvasionIlshenar" );

		}
		public virtual void StopRegVolonIlshenar()
		{
...

			{
				...
				{
					((RegVolonInvasionStone)item).CleanUpRegVolonIlshenar();
				}
			}
		}
		public  RegVolonInvasionStone( Serial serial ) : base( serial )
		{
		}
