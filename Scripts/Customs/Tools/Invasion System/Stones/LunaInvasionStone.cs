...
namespace Server.Items
{
	...
	{
		[Constructable]
		public LunaInvasionStone() : base( 0xED4 )
		{
			Movable = false;
			Hue = 33;
		...
		public virtual void CleanUpLunaMalas()
		{
			CleanUpSpawns( "LunaInvasionMalas" );
			CleanUpWayPoints( "LunaInvasionMalas" );

		}
		public virtual void StopLunaMalas()
		{
...

			{
				...
				{
					((LunaInvasionStone)item).CleanUpLunaMalas();
				}
			}
		}
		public LunaInvasionStone( Serial serial ) : base( serial )
		{
		}
