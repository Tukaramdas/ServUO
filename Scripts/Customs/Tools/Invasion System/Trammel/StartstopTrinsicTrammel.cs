...
namespace Server.Gumps
{
	public class StartStopTrinsictram : Gump
	{
		...
		public StartStopTrinsictram(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
            ...
            point.Name = "TrinsicInvasionTrammel";
            point1.Name = "TrinsicInvasionTrammel";
            point2.Name = "TrinsicInvasionTrammel";
            ...
            spawner1.Name = "TrinsicInvasionTrammel";
			spawner1.Respawn();
            ...
            spawner2.Name = "TrinsicInvasionTrammel";
			spawner2.Respawn();
            ...
            spawner3.Name = "TrinsicInvasionTrammel";
			spawner3.Respawn();
            ...
            spawner4.Name = "TrinsicInvasionTrammel";
			spawner4.Respawn();

            World.Broadcast(33, true, "Trinsic Trammel is under invasion.");
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
            ...
            Trinsictram.StopTrinsicTrammel();
            World.Broadcast(33, true, "Trinsic Trammel's invasion was successfully beaten back. No more invaders are left in the city.");
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
