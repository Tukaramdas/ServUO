...
namespace Server.Gumps
{
	public class StartStopYewtram : Gump
	{
		...
		public StartStopYewtram(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
			...
			point.Name = "YewInvasionTrammel";
			point1.Name = "YewInvasionTrammel";
			point2.Name = "YewInvasionTrammel";
			...
			point2.MoveToWorld( new Point3D(  950, 275, -90  ), Map.Malas );
          			spawner1.Name = "YewInvasionTrammel";
			spawner1.Respawn();
			...
			spawner2.Name = "YewInvasionTrammel";
			spawner2.Respawn();
			...
			spawner3.Name = "YewInvasionTrammel";
			spawner3.Respawn();
			...
			spawner4.Name = "YewInvasionTrammel";
			spawner4.Respawn();

                                           World.Broadcast( 33, true, "Yew Trammel is under invasion." );
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
			...
			yewtram.StopYewTrammel();
                                          World.Broadcast( 33, true, "Yew Trammel's invasion was successfully beaten back. No more invaders are left in the city." );
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
