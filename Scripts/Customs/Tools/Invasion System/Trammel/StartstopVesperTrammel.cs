...
namespace Server.Gumps
{
	public class StartStopVespertram : Gump
	{
		...
		public StartStopVespertram(Mobile from) : base(0,0)
		{
			m_Mobile = from;
			Closable = false;
			Dragable = true;
		...
		case 1:
		{
            ...
            point.Name = "VesperInvasionTrammel";
            point1.Name = "VesperInvasionTrammel";
            point2.Name = "VesperInvasionTrammel";
            ...
            spawner1.Name = "VesperInvasionTrammel";
			spawner1.Respawn();
            ...
            spawner2.Name = "VesperInvasionTrammel";
			spawner2.Respawn();
            ...
            spawner3.Name = "VesperInvasionTrammel";
			spawner3.Respawn();
            ...
            spawner4.Name = "VesperInvasionTrammel";
			spawner4.Respawn();

            World.Broadcast(33, true, "Vesper Trammel is under invasion.");
		               from.SendGump( new CityInvasion( from ) );
                                   	 break; 
                            }  
		case 2:
		{
            ...
            Vespertram.StopVesperTrammel();
            World.Broadcast(33, true, "Vesper Trammel's invasion was successfully beaten back. No more invaders are left in the city.");
		              from.SendGump( new CityInvasion( from ) );
                                   	break; 
				}
			}
