...
namespace Server.Misc
{
    public class VirtueArtifactSystem
    {
        ...
        //Virtue Artifact System Stone Edit below
        ...
        private static Type[] m_VirtueArtifacts = new Type[]
			{
                ...
                typeof(ValorGauntlets), typeof(HonestyGorget),// typeof( MapofKnownWorld ), typeof( AnkhPendant ), typeof (TenthAnniversarySculpture)// Need to Finish. typeof(HumilityCloak), 
			};
