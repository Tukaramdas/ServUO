...
{
    [CorpseName("Bill's Corpse")]
    public class Bill : Mobile
    {
        ...
        public class BillEntry : ContextMenuEntry
        {
            private Mobile m_Mobile; private Mobile m_Giver;
            public BillEntry(Mobile from, Mobile giver) : base(6146, 3)
            {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            if (mobile != null)
            {
                ...
                else if (dropped is Whip)
                {
                    ...
                    return false; } else { this.PrivateOverheadMessage(MessageType.Regular, 1153, false, "I have no need for this...", mobile.NetState); }
            }
            return false;
        }
    }
