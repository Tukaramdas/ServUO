...
{
    [CorpseName("Ted's Corpse")]
    public class Ted : Mobile
    {
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new TedEntry(from, this));
        }
        ...
        public class TedEntry : ContextMenuEntry
        {
            private Mobile m_Mobile; private Mobile m_Giver;
            public TedEntry(Mobile from, Mobile giver) : base(6146, 3)
            {
