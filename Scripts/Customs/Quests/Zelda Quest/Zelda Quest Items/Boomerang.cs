...
{
	public class MBoomerang : Item
	{
		[Constructable]
		public MBoomerang() : base( 0x10E5 )
		{
			Weight = 2.0;
            Hue = 1195;
			Name = "a Mythical Boomerang";
		}

		public MBoomerang( Serial serial ) : base( serial )
		{
		}
		...
		{
			private MBoomerang m_MBoomerang;

			public InternalTarget( MBoomerang Mboomerang ) : base( 10, false, TargetFlags.Harmful )
			{
				m_MBoomerang = Mboomerang;
			}
