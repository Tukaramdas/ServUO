...
//----------------------/----------------------------------------------/
"<BASEFONT COLOR=YELLOW>What? I'm not going to stop courting<BR>Elain for some weakling that<BR>hasn't ever picked up a sword!<BR><BR>" +
"<BASEFONT COLOR=YELLOW>Tell you what. If you can get the famous<BR>sword, the Gorgon Blade from Andora the<BR>Ranger, I'll give up chasing Elain.<BR><BR>" +
"<BASEFONT COLOR=YELLOW>That sounds like a good deal, hm? You<BR>can find her near the Guard Outpost. She<BR>protects West of the city." +
