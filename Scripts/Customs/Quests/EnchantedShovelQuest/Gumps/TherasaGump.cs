...
"<BASEFONT COLOR=YELLOW>The first piece I know is somewhere around here on Skara Brae.<BR><BR> There are quite a few monsters there, so you will have to be brave and kill them all.<BR>The Second is somewhere in Ilshenar, Compassion I think...<BR><BR>" +
"<BASEFONT COLOR=YELLOW>The Third and Final piece can be found on Valor Island - I think there are Vampires there, so be careful.<BR><BR>" +
