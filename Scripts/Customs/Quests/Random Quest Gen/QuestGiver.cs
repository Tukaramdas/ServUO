		...
		public override bool OnDragDrop(Mobile from, Item dropped)
		{
			...
			if ( mobile != null)
			{
					...
					QuestScroll m_Quest = (QuestScroll)dropped;
					    ...
					    {
						mobile.AddToBackpack ( new Gold( m_Quest.NLevel * Utility.RandomMinMax(500, 1000 ) ) );
					    }
					    else
					    {

						mobile.AddToBackpack ( new Gold( m_Quest.NLevel * Utility.RandomMinMax( 300, 600 ) ) );
...
namespace Server.Gumps
{
	public class QuestGiver_gump : Gump 
	{
		...
		public QuestGiver_gump( Mobile owner ) : base( 50,50 ) 
		{
			...
			"<BASEFONT COLOR=YELLOW><BR>" +
			"<BASEFONT COLOR=YELLOW>100 Gold - Level 1 Quest<BR>" +
			"<BASEFONT COLOR=YELLOW>200 Gold - Level 2 Quest<BR>" +
			"<BASEFONT COLOR=YELLOW>300 Gold - Level 3 Quest<BR>" +
			"<BASEFONT COLOR=YELLOW>400 Gold - Level 4 Quest<BR>" +
			"<BASEFONT COLOR=YELLOW>500 Gold - Level 5 Quest<BR>" +
			"<BASEFONT COLOR=YELLOW>600 Gold - Level 6 Quest<BR>" +
			"<BASEFONT COLOR=YELLOW><BR>" +
