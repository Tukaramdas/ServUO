...
{
    public class FemaleChestofjupiter : StuddedBustierArms
    {
        [Constructable]
        public FemaleChestofjupiter()
        {
            
            this.Hue = 1152;
            this.Name = "Female Chest of jupiter";
        ...
        public FemaleChestofjupiter( Serial serial ) : base( serial )
        {
        }
