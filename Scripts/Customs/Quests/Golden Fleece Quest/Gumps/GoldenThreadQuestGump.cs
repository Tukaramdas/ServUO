...
//----------------------------------------------------------------------------------------------------
AddPage( 0 );
            //AddImageTiled(54, 33, 369, 400, 3500); // 2624 );
...
"<BASEFONT COLOR=YELLOW>Please Help! I was attacked by a wolf<BR>" +
"<BASEFONT COLOR=YELLOW>Just north of here. Smite him and I will reward thee.<BR>" +
"<BASEFONT COLOR=YELLOW>Search for my attacker, a wolf named Scottie's Wolf.<BR>" +
"<BASEFONT COLOR=YELLOW>He is in the north of Haven.<BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW>Kill the wolf and retrieve 10 <BR>" +
"<BASEFONT COLOR=YELLOW>special threads I need to use <BR>" +
"<BASEFONT COLOR=YELLOW>in order to make my special items.<BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW>Once you have killed the wolf and <BR>" +
"<BASEFONT COLOR=YELLOW>retrieved the threads, bring them back <BR>" +
"<BASEFONT COLOR=YELLOW> to me for the reward!<BR>" +
"</BODY>", false, true);
//----------------------/----------------------------------------------/
AddImage( 430, 9, 10441);
       //     AddImageTiled( 40, 38, 17, 391, 9263 );
            AddImage( 6, 25, 10421 );AddImage( 34, 12, 10420 );
