...
"<BASEFONT COLOR=White>There is a creature that carries these crystals. It is thought that it wanders near the lighthouse. Just follow the path down.<br><br>" +
