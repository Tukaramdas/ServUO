...
"<BASEFONT COLOR=Yellow>The Kraken is hiding here, near Bucs Den. If you have a boat can<br>" +
"<BASEFONT COLOR=Yellow>you hunt the monster down and bring me back my favorite cutlass?<br>" +
"<BASEFONT COLOR=Yellow>Yarr! If ye can do this, I will give you one of my other cutlasses!<I></I><br>" + 
"</BODY>", false, true);
...
//--------------------------------------------------------------------------------------------------------------
      ...
      { 
         ...
         { 
            ...
            { 
               //Cancel 
               from.SendMessage( "I hear The Kraken still be hiding in the Ocean near Bucs Den somewhere." );
               break; 
            } 
