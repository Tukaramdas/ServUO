	...
	public class ChristmasCandle2011 : Item, IDyable
	{
		public static string GetRandomTitle()
		{
			string[] titles = new string[]
				{
					/*  1 */ "Happy Holidays, from Lord British",
					/* 2 */ "Happy Holidays, from Lord Blackthorn",
					/* 3 */ "Seasons Greetings, from Sir Dupre",
					/* 4 */ "Bah Humbug!*muhaha*",
					/* 5 */ "Wishing you a wonderful Holiday Season!",
					/* 6 */ "Were you naughty this year? *tisk tisk*",
					/* 7 */ "Happy Holidays 2011, from Capt. Blackheart",
					/* 8 */ "Happy Holidays 2011, from Mondain",
