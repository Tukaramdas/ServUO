...
4-) SKILLBALL The skillball will let you choose 7 skills to GM. You may consider GM'ing tedious, or expensive, skills (hiding, lockpick, fishing, magery, taming etc) <br>
5-) BANKSTONE You got a bankstone for bank access at home. Simply stand where you want to place the stone and double click the deed. If you double click the stone it will re-deed. You can interact with the bank stone as you would a banker (say: 'bank' to open bank, say 'balance' to view bank account balance) <br>
