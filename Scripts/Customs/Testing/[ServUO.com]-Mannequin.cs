...
{
	public class AMannequin : BaseCreature
	{
        ...
        {
            private Mobile from;
            private AMannequin dummy;

            public CustomizeBodyEntry(Mobile mob, AMannequin mann)
                : base(1151585, 4)
            {
                from = mob;
                dummy = mann;
            ...
            public override void OnClick()
            {
                if (from == dummy.Owner)
                {
                    from.SendGump(new AMannequinGump(from, dummy));
                }
            }
	    }
	    ...
	    private class SwitchClothesEntry : ContextMenuEntry
	    {
            ...
            public SwitchClothesEntry(Mobile mob, AMannequin mann)
                : base(1151606, 4)
            {
                from = mob;
                dummy = mann;
        ...
        private class RotateEntry : ContextMenuEntry
        {
            ...
            public RotateEntry(Mobile mob, AMannequin mann)
                : base(1151586, 4)
            {
                from = mob;
                dummy = mann;
        ...
        private class RedeedEntry : ContextMenuEntry
        {
            ...
            public RedeedEntry(Mobile mob, AMannequin mann)
                : base(1151601, 4)
            {
                from = mob;
                dummy = mann;
            ...
            public override void OnClick()
            {
                if (from == dummy.Owner)
                {
                    ...
                    dummy.Delete();
                    from.AddToBackpack(new AMannequinDeed());
                }
            }
        }
        ...
        private bool SwitchClothes(Mobile from)
        {
            ...
            {
                from.SendMessage("Your AMannequin must be in your own house to use it.");
                return false;
            }
            ...
            {
                from.SendMessage("You and your AMannequin must be in the same house to do that!");
                return false;
            }

            if (!CanSee(from) || !from.InLOS(this))
            {
                from.SendMessage("You and your AMannequin must be able to see eachother to do that.");
                return false;
            }
            ...
            List<Item> AMannequinItems = new List<Item>();
            ...
            foreach (Item item in AMannequinItems)
            {
                RemoveItem(item);
            }
		...
		[Constructable]
		public AMannequin(Mobile owner) : base( AIType.AI_Use_Default, FightMode.None, 1, 1, 0.2, 0.2 )
		{
			m_Owner = owner;
		    Female = owner.Female;
		    Race = owner.Race;
		...
		public AMannequin( Serial serial ) : base( serial )
		{
		}
        ...
        private class AMannequinGump : Gump
        {
            private Mobile m_From;
            private AMannequin m_AMannequin;
            ...
            private void AddBackground()
            {
                ...
                AddImage(240, 18, GetLgBodyId(), GetHue(m_AMannequin.Hue)); // Body
                AddImage(240, 18, GetHairId(m_AMannequin.HairItemID), GetHue(m_AMannequin.HairHue)); // Hair
                if (!m_AMannequin.Female)
                    AddImage(240, 18, GetHairId(m_AMannequin.FacialHairItemID), GetHue(m_AMannequin.FacialHairHue)); // Facial Hair

                AddLabel(100, 18, 1153, "AMannequin CUSTOMIZATION MENU");
            }
            ...
            private void AddButtons()
            {
                ...
                AddLabel(60, 240, m_AMannequin.Female ? 0x20 : 1152, string.Format("Change Facial Hair{0}",
            ...
            private int GetLgBodyId()
            {
                ...
                {
                    case "Human":
                        return m_AMannequin.Female ? 1888 : 1889;
                    case "Elf":
                        return m_AMannequin.Female ? 1893 : 1894;
                    case "Gargoyle":
                        return m_AMannequin.Female ? 1898 : 1899;
                }
                return 1889;
            }
            ...
            private int GetHairId(int fromHairId)
            {
                switch (fromHairId)
                {
                    ...
                    case 0x2FC0: //Long Feather
                        return m_AMannequin.Female ? 1775 : 1785;
                    case 0x2FC1: //Short
                        return m_AMannequin.Female ? 1776 : 1786;
                    case 0x2FC2: //Mullet
                        return m_AMannequin.Female ? 1777 : 1787;
                    case 0x2FCE: //Knob
                        return m_AMannequin.Female ? 1779 : 1790;
                    case 0x2FCF: //Braided
                        return m_AMannequin.Female ? 1780 : 1791;
                    case 0x2FD1: //Spiked
                        return m_AMannequin.Female ? 1783 : 1793;
                    case 0x2FCC: //Flower
                        return 1778;
                    ...
                    // HUMAN HAIR
                    case 0x203B: //Short
                        return m_AMannequin.Female ? 1847 : 1875;
                    case 0x203C: //Long
                        return m_AMannequin.Female ? 1837 : 1876;
                    case 0x203D: //Pony Tail
                        return m_AMannequin.Female ? 1845 : 1879;
                    case 0x2044: //Mohawk
                        return m_AMannequin.Female ? 1843 : 1877;
                    case 0x2045: //Pageboy
                        return m_AMannequin.Female ? 1844 : 1871;
                    case 0x2047: //Curly
                        return m_AMannequin.Female ? 1839 : 1873;
                    case 0x2049: //Two tails
                        return m_AMannequin.Female ? 1836 : 1870;
                    case 0x204A: //Top Knot
                        return m_AMannequin.Female ? 1840 : 1874;
                    case 0x2046: //Buns
                        return 1841;
                    ...
                    case 0x203E: // Long Beard
                        return m_AMannequin.Female ? 30088 : 1883;
                    case 0x203F: // Short Beard
                        return m_AMannequin.Female ? 30088 : 1885;
                    case 0x2040: // Goatee
                        return m_AMannequin.Female ? 30088 : 1881;
                    case 0x2041: // Moustache
                        return m_AMannequin.Female ? 30088 : 1884;
                    case 0x204B: // Short Beard and Moustache
                        return m_AMannequin.Female ? 30088 : 1886;
                    case 0x204C: // Long Beard and Moustache
                        return m_AMannequin.Female ? 30088 : 1882;
                    case 0x204D: // Vandyke
                        return m_AMannequin.Female ? 30088 : 1887;
                    ...
                    case 0x42AD:
                        return m_AMannequin.Female ? 30088 : 1903;
                    case 0x42AE:
                        return m_AMannequin.Female ? 30088 : 1904;
                    case 0x42AF:
                        return m_AMannequin.Female ? 30088 : 1905;
                    case 0x42B0:
                        return m_AMannequin.Female ? 30088 : 1906;
                }
                return 30088;
            }

            public AMannequinGump(Mobile from, AMannequin AMannequin)
                : this(from, AMannequin, "", false)
            {
            }

            public AMannequinGump(Mobile from, AMannequin AMannequin, string message, bool success)
                : base(0, 0)
            {
                m_From = from;
                m_AMannequin = AMannequin;

                from.CloseGump(typeof (AMannequinGump));
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                if (CHARGE_FOR_CUSTOMIZATIONS)
                {
                    ...
                    {
                        m_From.SendGump(new AMannequinGump(m_From, m_AMannequin, "* Thou dost not have enough Gold. *", false));
                        return;
                    }
                ...
                switch (info.ButtonID)
                {
                    case (int)Buttons.RANDOMIZE:
                        // Randomize...
                        m_AMannequin.Female = Utility.RandomBool();
                        m_AMannequin.Race = Race.Races[Utility.Random(Race.AllRaces.Count)];
                        m_AMannequin.SetBody();
                        m_From.SendGump(new AMannequinGump(m_From, m_AMannequin, message, success));
                        break;
                    case (int)Buttons.CHANGE_GENDER:
                        // Change gender...
                        m_AMannequin.Female = !m_AMannequin.Female;
                        UpdateBody();
                        m_From.SendGump(new AMannequinGump(m_From, m_AMannequin, message, success));
                        break;
                    case (int)Buttons.CHANGE_HAIR_COLOR:
                        // Change Hair Color...
                        switch (m_AMannequin.Race.RaceID)
                        {
                            case 0: // Human
                                m_From.SendGump(new CustomHuePickerGump(m_AMannequin, HumanHairColor, HairCallback, m_From));
                                break;
                            case 1: // Elf
                                m_From.SendGump(new CustomHuePickerGump(m_AMannequin, ElfHairColor, HairCallback, m_From));
                                break;
                            case 2: // Gargoyle
                                m_From.SendGump(new CustomHuePickerGump(m_AMannequin, GargoyleHairColor, HairCallback, m_From));
                                break;
                        }
                        break;
                    case (int)Buttons.CHANGE_SKIN_COLOR:
                        ...
                        {
                            case 0: // Human
                                m_From.SendGump(new CustomHuePickerGump(m_AMannequin, HumanSkinColor, SkinCallback, m_From));
                                break;
                            case 1: // Elf
                                m_From.SendGump(new CustomHuePickerGump(m_AMannequin, ElfSkinColor, SkinCallback, m_From));
                                break;
                            case 2: // Gargoyle
                                m_From.SendGump(new CustomHuePickerGump(m_AMannequin, GargoyleSkinColor, SkinCallback, m_From));
                                break;
                        }
                        break;
                    case (int)Buttons.CHANGE_HAIR:
                        // Change Hairstyle...
                        Utility.AssignRandomHair(m_AMannequin);
                        m_From.SendGump(new AMannequinGump(m_From, m_AMannequin, message, success));
                        break;
                    case (int)Buttons.CHANGE_FACIAL_HAIR:
                        // Change Facial Hairstyle...
                        Utility.AssignRandomFacialHair(m_AMannequin);
                        m_From.SendGump(new AMannequinGump(m_From, m_AMannequin, message, success));
                        break;
                    case (int)Buttons.CHANGE_RACE:
                        // Change Race...
                        if (m_AMannequin.Race.RaceID >= Race.AllRaces.Count - 1)
                        {
                            m_AMannequin.Race = Race.AllRaces[0];
                        }
                        else
                        {
                            m_AMannequin.Race = Race.AllRaces[m_AMannequin.Race.RaceID + 1];
                        }
                        UpdateBody();
                        m_From.SendGump(new AMannequinGump(m_From, m_AMannequin, message, success));
                        break;
            ...
            private void UpdateBody()
            {
                ...
                {
                    case 0: // Human
                        m_AMannequin.Body = m_AMannequin.Female ? 401 : 400;
                        break;
                    case 1: // Elf
                        m_AMannequin.Body = m_AMannequin.Female ? 606 : 605;
                        break;
                    case 2: // Gargoyle
                        m_AMannequin.Body = m_AMannequin.Female ? 667 : 666;
                        break;
                }
                Utility.AssignRandomHair(m_AMannequin);
                Utility.AssignRandomFacialHair(m_AMannequin);
                m_AMannequin.Hue = m_AMannequin.Race.RandomSkinHue();
                m_AMannequin.InvalidateProperties();
            }
        }
        ...
        {
            from.HairHue = hue;
            if (state is Mobile && from is AMannequin && ((Mobile)state) == ((AMannequin)from).Owner)
            {
                ((AMannequin)from).InvalidateProperties();
                ((Mobile) state).SendGump(new AMannequinGump(((Mobile) state), ((AMannequin) from),
    ...
    public class AMannequinDeed : Item
    {
        ...
        [Constructable]
        public AMannequinDeed()
            : base(0x14F0)
        {
            Name = "AMannequin Deed";
            LootType = LootType.Blessed;
        }

        public AMannequinDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (IsChildOf(from.Backpack))
            {
                ...
                {
                    from.Target = new PlaceAMannequinTarget(this);
                }
                else
                {
        ...
        private class PlaceAMannequinTarget : Target
        {
            private AMannequinDeed mDeed;

            public PlaceAMannequinTarget(AMannequinDeed deed)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is StaticTarget)
                {
                    ...
                    {
                        AMannequin m =
                            (AMannequin)Activator.CreateInstance(typeof(AMannequin), new object[] { from });
