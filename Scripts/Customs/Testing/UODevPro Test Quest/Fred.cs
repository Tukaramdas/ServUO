...
//                      This script was created on 6/15/2016 17:33:28
//===============================================================================
...
{
	public class Fred : MondainQuester
	{
		[Constructable]
		public Fred() : base("Fred","Welcome sucker...friend")
		{
		}

		public Fred(Serial serial) : base(serial)
		{
		}

		public override Type[] Quests { get { return new Type[] { typeof(Welcome) }; } }
