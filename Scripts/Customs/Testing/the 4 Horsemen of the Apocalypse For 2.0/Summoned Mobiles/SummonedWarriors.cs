...
{
	[CorpseName( "summoned warrior corpse" )]
	public class SummonedWarriors : BaseCreature
	{
		...
		[Constructable]
		public SummonedWarriors() : this( null )
		{
		}
		...
		public SummonedWarriors( Mobile owner ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			m_Owner = owner;
			m_ExpireTime = DateTime.Now + TimeSpan.FromMinutes( 0.3 );

			Name = "Summoned Warriors";
        ...
        public SummonedWarriors(Serial serial)
            : base(serial)
		{
		}
