...
{
	[CorpseName( "corpse of anti-christ" )]
	public class LostSoulsOfTheAntiChrist : BaseCreature
	{
		...
		[Constructable]
		public LostSoulsOfTheAntiChrist() : this( null )
		{
		}
		...
		public LostSoulsOfTheAntiChrist( Mobile owner ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			m_Owner = owner;
			m_ExpireTime = DateTime.Now + TimeSpan.FromMinutes( 0.3 );

			Name = "Souls Of The Anit-Christ";
        ...
        public LostSoulsOfTheAntiChrist(Serial serial)
            : base(serial)
		{
		}
