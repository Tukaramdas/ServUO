...
{
	public class ScalesOfFamine : Item
	{
		[Constructable]
		public ScalesOfFamine() : base( 0x1852 )
		{
            Name = "Scales Of Famine";
			Weight = 4.0;
		}

        public ScalesOfFamine(Serial serial)
            : base(serial)
		{
		}
		...
		{
			private ScalesOfFamine m_Item;

			public InternalTarget( ScalesOfFamine item ) : base( 1, false, TargetFlags.None )
			{
				m_Item = item;
			}
