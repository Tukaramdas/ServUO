...
Resi***End of Text***sting spells can lower or negate damage taken from harmful spells
...
If you mThis is end of visual text.***Text ends here*** or fletcher, Yew is the town for you.
...
[Recall - command that will automaically take you to Tito Tim's Casino. Good for getting away for a break.
[BoatControl - to get a pop up gump to control your boat.
[TurnBackToDeed - command instead of an axe to redeed a household item.
[ChangeHairStyle - to change your hair or beard, for a small fee.
[Band - to get bandage target icon.
[BandSelf - to apply bandage to yourself.
...
[Loot - If a critter has special loot, say for a quest, it is recommended you loot it by hand before using the loot command - just in case.
