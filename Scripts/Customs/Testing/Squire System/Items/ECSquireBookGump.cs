...
namespace Server.Gumps
{
    public class ECSquireBookGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            this.AddButton(40, 90, 4005, 4007, (int)Buttons.Button1, GumpButtonType.Page, 2);//Go to page 2 Player Commands
            this.AddButton(40, 120, 4005, 4007, (int)Buttons.Button2, GumpButtonType.Page, 3);//Go to page 3 Shard Info
            this.AddButton(40, 150, 4005, 4007, (int)Buttons.Button3, GumpButtonType.Page, 4);//Go to page 4 Getting Started
            this.AddButton(180, 90, 4005, 4007, (int)Buttons.Button4, GumpButtonType.Page, 5);//Go to page 5 - Skill I
            ...
            this.AddLabel(195, 65, 0, @"Skill Part I");//Gump Title
...
MISC
Begging: NPCs might give you gold or items.
Forensics: Allows you to see how something died
Item Identification: The skill to identify items
Taste Identification: Can detect poison on food
COMBAT
Anatomy: The skill of analyzing a living being (works with combat, healing & vet)
Archery: The skill of fighting with ranged weapons
Fencing: The skill of fighting with piercing weapons
Focus: Warrior's Meditation. Increases Mana & Stamina.
Healing: Healing or resurrecting a target (Requires bandages, gets bonus from Anatomy)
Mace Fighting: The skill of fighting with blunt weapons 
Parry: Block melee & archery attacks
Swordsmanship: The skill of fighting with slashing weapons
Tactics: The skill of finding a target's weak spot
Throwing: Ranged fighting for Gargoyles race
Wrestling: The skill of fighting bare handed
TRADE (crafting requires the proper tools and supplies)
Alchemy: The skill of grinding reagents to create potions 
Blacksmith: The skill of crafting weapons and armors with ingots and other materials
...
Fletching: The skill of crafting bows and ammunition
...
Tinkering: The skill of making various items, and tools
Arms Lore: Gives bonus to crafting skills", (bool)true, (bool)true);
...
(bool)true, (bool)true);
            ...
            //this.AddLabel(205, 220, 0, @"5");
            this.AddButton(35, 245, 4014, 4015, (int)Buttons.BackButton3, GumpButtonType.Page, 1);//ack to page 1
