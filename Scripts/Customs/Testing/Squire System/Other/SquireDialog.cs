...
namespace Server.Mobiles
{
	public enum SquireDialogTree
	{
		...
		CannotStealWhileLeavingFaction,
		CannotStealOwnSigil,
		CannotStealSigilWhilePurifying,
		SigilHasReturnedBecauseAlreadyHaveOne,
		SigilHasReturnedBecauseBackpackIsFull,
		SuccessfulSigilSteal,
		NotSkilledEnoughToStealSigil,
		NotInAFactionSteal,
		...
		public static void DoSquireDialog( Mobile master, Squire squire, SquireDialogTree dialog, BaseCreature creature, PlayerMobile player )
		{
			...
			else if( dialog == SquireDialogTree.ASquiresConcern )
			{
				switch( Utility.Random( 6 ) )
				{
					...
					case 1: squire.Say( squire.m_MasterNickname.ToUpper() + " Wher are you!" ); break;
			...
			else if( dialog == SquireDialogTree.CannotStealWhileLeavingFaction )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "We cannot steal a sigil, " + squire.m_MasterNickname + ", not while we're leaving!" ); break;
					case 4: squire.Emote( "*Unable to steal sigil while leaving the faction.*" ); break;
					case 3: squire.Say( "Sigils cannot be stolen while we're leaving, " + squire.m_MasterNickname + "!" ); break;
					case 2: squire.Say( "We're unable to steal sigils while leaving, " + squire.m_MasterNickname + "!" ); break;
					case 1: squire.Say( squire.m_MasterNickname + ", we cannot steal sigils while leaing a faction" ); break;
					case 0: squire.Say( "We cannot steal sigils while we're leaving a faction." ); break;
				}
			}
			else if( dialog == SquireDialogTree.CannotStealOwnSigil )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "That is ours, " + squire.m_MasterNickname + ", why steal it?" ); break;
					case 4: squire.Emote( "*Refuses to steal what is yours.*" ); break;
					case 3: squire.Say( "Why would we steal what's ours, " + squire.m_MasterNickname + "?" ); break;
					case 2: squire.Say( "We're unable to steal what's ours, " + squire.m_MasterNickname + "!" ); break;
					case 1: squire.Say( squire.m_MasterNickname + ", that's already ours!" ); break;
					case 0: squire.Say( "We cannot steal our own sigil!" ); break;
				}
			}
			else if( dialog == SquireDialogTree.CannotStealSigilWhilePurifying )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "That needs to purify, " + squire.m_MasterNickname + ", we cannot steal that yet!" ); break;
					case 4: squire.Emote( "*Is unable to steal it while it's purifying.*" ); break;
					case 3: squire.Say( "We cannot steal that yet, " + squire.m_MasterNickname + "!" ); break;
					case 2: squire.Say( "It's still purifying, " + squire.m_MasterNickname + "!" ); break;
					case 1: squire.Say( squire.m_MasterNickname + ", we cannot steal it yet!" ); break;
					case 0: squire.Say( "That is not fully purified!" ); break;
				}
			}
			else if( dialog == SquireDialogTree.SigilHasReturnedBecauseAlreadyHaveOne )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "It returned to its home, " + squire.m_MasterNickname + ", I cannot hold two sigils!" ); break;
					case 4: squire.Emote( "*Was unable to hold two sigils.*" ); break;
					case 3: squire.Say( "The sigil has returned, " + squire.m_MasterNickname + "!" ); break;
					case 2: squire.Say( "I cannot hold two sigils, " + squire.m_MasterNickname + "!" ); break;
					case 1: squire.Say( squire.m_MasterNickname + ", I cannot hold two sigils!" ); break;
					case 0: squire.Say( "The sigil has returned to its location because I am already carrying another one." ); break;
				}
			}
			else if( dialog == SquireDialogTree.SigilHasReturnedBecauseBackpackIsFull )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "The sigil is gone, " + squire.m_MasterNickname + ", because my backpack is full." ); break;
					case 4: squire.Emote( "*Is missing the sigil because their pack is full.*" ); break;
					case 3: squire.Say( "My backpack is too full, so the sigil sent itself back, " + squire.m_MasterNickname + "!" ); break;
					case 2: squire.Say( "The sigil returned itself, " + squire.m_MasterNickname + "!" ); break;
					case 1: squire.Say( squire.m_MasterNickname + ", the sigil has returned because my pack is full" ); break;
					case 0: squire.Say( "My backpack is full, the sigil returned itself." ); break;
				}
			}
			else if( dialog == SquireDialogTree.SuccessfulSigilSteal )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "The sigil is ours, " + squire.m_MasterNickname + ", run!" ); break;
					case 4: squire.Emote( "*Successfully collects the sigil.*" ); break;
					case 3: squire.Say( "I have the sigil, " + squire.m_MasterNickname + "!" ); break;
					case 2: squire.Say( "The sigil is ours, " + squire.m_MasterNickname + "!" ); break;
					case 1: squire.Say( "Run! " + squire.m_MasterNickname + ", run! We have the sigil!" ); break;
					case 0: squire.Say( "We have the sigil, run!" ); break;
				}
			}
			else if( dialog == SquireDialogTree.NotSkilledEnoughToStealSigil )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "I'm not skilled enough, " + squire.m_MasterNickname + ", I cannot steal that sigil." ); break;
					case 4: squire.Emote( "*Realizes they are not skilled enough to steal the sigil.*" ); break;
					case 3: squire.Say( "I cannot steal the sigil now, " + squire.m_MasterNickname + "." ); break;
					...
					case 0: squire.Say( "I am not skilled enough to steal the sigil." ); break;
				}
			}
			else if( dialog == SquireDialogTree.NotInAFactionSteal )
			{
				switch( Utility.Random( 6 ) )
				{
					case 5: squire.Say( "I don't believe we should steal that, " + squire.m_MasterNickname + ", not while we're outside a faction." ); break;
					case 4: squire.Emote( "*Refuses to take the sigil while not with a faction.*" ); break;
					case 3: squire.Say( "We have nothing to gain from stealing that sigil, " + squire.m_MasterNickname + "." ); break;
					case 2: squire.Say( "Why would I steal that, " + squire.m_MasterNickname + "?" ); break;
					case 1: squire.Say( squire.m_MasterNickname + ", I cannot steal this sigil when we're not in a faction." ); break;
					case 0: squire.Say( "We are currently outside of a faction and cannot steal a sigil." ); break;
				}
			}
			...
			else if( dialog == SquireDialogTree.NoChivalryBook )
			{
				switch( Utility.Random( 6 ) )
				{
					...
					case 0: squire.Say( "I will need a book of chivalry to cast that." ); break;
				}
			}
