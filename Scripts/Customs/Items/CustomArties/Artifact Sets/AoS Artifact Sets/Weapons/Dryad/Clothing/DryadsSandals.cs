...
{
	public class DryadsSandals : Sandals
	{
		public override int LabelNumber{ get{ return 1061111; } } // DryadsSandals
		...
		public DryadsSandals( Serial serial ) : base( serial )
		{
		}
